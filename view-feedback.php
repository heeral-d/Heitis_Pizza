...
<head>
  ...
  <title>Feedback No. <?php echo $ticket_id.' - '. $type;?></title>

  <!-- Favicons-->
  <link rel="icon" href="images/favicon/favicon-32x32.jpg" sizes="32x32">
  <!-- Favicons-->
  <link rel="apple-touch-icon-precomposed" href="images/favicon/apple-touch-icon-152x152.jpg">
  <!-- For iPhone -->
  <meta name="msapplication-TileColor" content="#00bcd4">
  <meta name="msapplication-TileImage" content="images/favicon/mstile-144x144.jpg">
  <!-- For Windows Phone -->
            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light"><i class="mdi-editor-attach-money"><font size = "4"><?php echo $balance;?></font></i></a>
                        </li>
                    </ul>					
                </div>
            </nav>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Feedbacks</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="feedback.php">All Feedbacks</a>
                                </li>
								<?php
									$sql = mysqli_query($con, "SELECT DISTINCT status FROM tickets WHERE poster_id = $user_id;");
									while($row = mysqli_fetch_array($sql)){
                                    echo '<li><a href="feedback.php?status='.$row['status'].'">'.$row['status'].'</a>
                                    </li>';
									}
									?>
                                </ul>
...
<div class="section">
								...
								echo '<ul id="task-card" class="collection with-header">
									<div id="card-alert" class="card cyan">
										...
										<span class="card-title white-text darken-1">Feedback No. '.$ticket_id.'</span>
  ...
  <footer class="page-footer">
    ...
    <div class="container">
        <span>Copyright © 2019 <a class="grey-text text-lighten-4" href="#" target="_blank">HeitiTech</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Aditi & Heeral</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
