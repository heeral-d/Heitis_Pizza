  ...
  <div id="main">
    ...
    <div class="wrapper">
                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> Feedbacks</a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
									...
									"><a href="feedback.php">All Feedbacks</a>
                                </li>
								<?php
                                    ...
                                    echo '<li class='.(isset($_GET['status'])?($status == $_GET['status'] ? 'active' : ''): '').'><a href="feedback.php?status='.$row['status'].'">'.$row['status'].'</a>
                                    </li>';
									}
									?>
                                </ul>
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Give your valueable Feeedbck.</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Give feedback</h4>
              </div>
<div>
        ...
        <div class="container">
          ...
          <div class="divider"></div>
								...
								<?php
									...
									while($row = mysqli_fetch_array($sql)){								                                
									echo'<a href="view-feedback.php?id='.$row['id'].'"class="collection-item">
                                        <div class="row">
                                            <div class="col s6">
